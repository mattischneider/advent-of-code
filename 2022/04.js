...
testAssignments = getAssignmentPairs('2022/04_test')
console.assert(getNumberOfContainments(testAssignments) == 2)
console.assert(getNumberOfOverlapSections(testAssignments) == 4)

assignments = getAssignmentPairs('2022/04_input')
